...
cert_path = "<PATH>/server_supra_certificate.pem"
# The path to the private key to be used when negotiating TLS connections.
private_key_path = "<PATH>/server_supra_key.pem"

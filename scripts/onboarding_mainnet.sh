...
function automated_validator_node_setup_and_configuration() {
    ...
    copy_files_to_node_operator_folder $SCRIPT_EXECUTION_LOCATION $BASE_PATH/supra-nodeops-data/release_round6_data/operators/supra_mainnet_$ip_address 
    ...
    echo ""
    echo "1. Files are copied to supra-nodeops-data/release_round6_data/operators/supra_mainnet_$ip_address"
